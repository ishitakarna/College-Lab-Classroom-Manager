...
import 'package:CollegeManager/pages/labs/GML/GMlabEdit.dart';
import 'package:flutter/material.dart';
import 'package:CollegeManager/backend/auth.dart';

class GMLLab extends StatefulWidget {
  @override
  _GMLLabState createState() => _GMLLabState();
}

class _GMLLabState extends State<GMLLab> {
  ...
  Future getData() async {
    compStatus = await authServices.getGMLLabComp(compID);
