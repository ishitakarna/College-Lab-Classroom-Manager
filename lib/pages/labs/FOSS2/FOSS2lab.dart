...
import 'package:CollegeManager/pages/labs/FOSS2/FOSS2labEdit.dart';
import 'package:flutter/material.dart';
import 'package:CollegeManager/backend/auth.dart';

class FOSS2Lab extends StatefulWidget {
  @override
  _FOSS2LabState createState() => _FOSS2LabState();
}

class _FOSS2LabState extends State<FOSS2Lab> {
  ...
  Future getData() async {
    compStatus = await authServices.getFOSS2LabComp(compID);
