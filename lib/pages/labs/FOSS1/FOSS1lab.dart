...
import 'package:CollegeManager/pages/labs/FOSS1/FOSS1labEdit.dart';
import 'package:flutter/material.dart';
import 'package:CollegeManager/backend/auth.dart';

class FOSS1Lab extends StatefulWidget {
  @override
  _FOSS1LabState createState() => _FOSS1LabState();
}

class _FOSS1LabState extends State<FOSS1Lab> {
  AuthServices authServices = new AuthServices();
  CompStatus compStatus;
  bool loading = true;
  bool loadingSeats = true;
  Future getData() async {
    compStatus = await authServices.getFOSS1LabComp(compID);
