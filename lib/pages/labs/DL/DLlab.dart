...
import 'package:CollegeManager/pages/labs/DL/DLlabEdit.dart';
import 'package:flutter/material.dart';
import 'package:CollegeManager/backend/auth.dart';

class DLLab extends StatefulWidget {
  @override
  _DLLabState createState() => _DLLabState();
}

class _DLLabState extends State<DLLab> {
  ...
  Future getData() async {
    compStatus = await authServices.getDLLabComp(compID);
