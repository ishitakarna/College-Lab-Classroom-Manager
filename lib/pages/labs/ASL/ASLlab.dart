...
import 'package:CollegeManager/pages/labs/ASL/ASLlabEdit.dart';
import 'package:flutter/material.dart';
import 'package:CollegeManager/backend/auth.dart';

class ASLLab extends StatefulWidget {
  @override
  _ASLLabState createState() => _ASLLabState();
}

class _ASLLabState extends State<ASLLab> {
  ...
  Future getData() async {
    compStatus = await authServices.getASLLabComp(compID);
